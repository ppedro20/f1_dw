-- ═══════════════════════════════════════════════════════════════════
-- F1 Data Warehouse — Popular dim_data (1950-01-01 a 2030-12-31)
-- Executar DEPOIS de criar_f1_dw.sql
-- ═══════════════════════════════════════════════════════════════════
USE f1_dw;
GO
...
SELECT COUNT(*) AS total_dias_gerados FROM dbo.dim_data;
-- Deve retornar 29584 (1950-01-01 a 2030-12-31)
GO
